...
#[cfg(not(target_arch = "wasm32"))]
criterion_group!(benches_main, bench_impl::benchmarks_main);
#[cfg(not(target_arch = "wasm32"))]
criterion_group!(benches_rate, bench_impl::benchmarks_rate);
#[cfg(not(target_arch = "wasm32"))]
criterion_group!(benches_engine, bench_impl::benchmarks_engine);
...
fn main() {
    eprintln!("benchmarks are not supported on wasm32");
}
